...
--CREATE TABLE [dbo].[EH_StudentSummaryWithAllAss](
--	[SchoolYear] [varchar](10) NULL,
--	[StudentId] [varchar](500) NULL,
--	[StudentSchool] [varchar](500) NULL,
--	[SchoolIdentifier] [varchar](500) NULL,
--	[DistrictStudentId] [varchar](500) NULL,
--	[StateStudentId] [varchar](500) NULL,
--	[StudentName] [varchar](500) NULL,
--	[Last_Name] [varchar](500) NULL,
--	[First_Name] [varchar](500) NULL,
--	[GradeCode] [varchar](500) NULL,
--	[Gender] [varchar](500) NULL,
--	[Team] [varchar](500) NULL,
--	[crdc_504] [varchar](500) NULL,
--	[SPED] [varchar](500) NULL,
--	[ELL] [varchar](500) NULL,
--	[HighNeeds] [varchar](500) NULL,
--	[Ethnicity] [varchar](500) NULL,
--	[EntryDate] [varchar](500) NULL,
--	[ExitDate] [varchar](500) NULL,
--	[Classof] [varchar](100) NULL,
--	[GraduationYear] [varchar](100) NULL,
--	[COURSE_NUMBER] [varchar](500) NULL,
--	[COURSE_NAME] [varchar](500) NULL,
--	[SECTION_NUMBER] [varchar](500) NULL,
--	[SECTIONID] [varchar](500) NULL,
--	[TEACHERID] [varchar](500) NULL,
--	[DistrictStaffID] [varchar](500) NULL,
--	[Teacher] [varchar](500) NULL,
--	[TERMID] [varchar](500) NULL,
--	[Q1] [varchar](500) NULL,
--	[Q1_per] [varchar](500) NULL,
--	[Q2] [varchar](500) NULL,
--	[Q2_per] [varchar](500) NULL,
--	[E1] [varchar](500) NULL,
--	[E1_per] [varchar](500) NULL,
--	[S1] [varchar](500) NULL,
--	[S1_per] [varchar](500) NULL,
--	[Q3] [varchar](500) NULL,
--	[Q3_per] [varchar](500) NULL,
--	[Q4] [varchar](500) NULL,
--	[Q4_per] [varchar](500) NULL,
--	[E2] [varchar](500) NULL,
--	[E2_per] [varchar](500) NULL,
--	[S2] [varchar](500) NULL,
--	[S2_per] [varchar](500) NULL,
--	[SAT_TotalScore] [varchar](500) NULL,
--	[SAT_ReadingScore] [varchar](500) NULL,
--	[SAT_ReadingBenchmark] [varchar](500) NULL,
--	[SAT_ReadingMetScore] [varchar](500) NULL,
--	[SAT_MathScore] [varchar](500) NULL,
--	[SAT_MathBenchmark] [varchar](500) NULL,
--	[SAT_MathMetScore] [varchar](500) NULL,
--	[PSAT_TotalScore] [varchar](500) NULL,
--	[PSAT_ReadingScore] [varchar](500) NULL,
--	[PSAT_ReadingBenchmark] [varchar](500) NULL,
--	[PSAT_ReadingMetScore] [varchar](500) NULL,
--	[PSAT_MathScore] [varchar](500) NULL,
--	[PSAT_MathBenchmark] [varchar](500) NULL,
--	[PSAT_MathMetScore] [varchar](500) NULL,
--	[DIBELS_Reading_ScaleScore] [varchar](500) NULL,
--	[DIBELS_Reading_ProfLevel] [varchar](500) NULL,
--	[IAB_EnglishLanguageArts_ScaleScore] [varchar](500) NULL,
--	[IAB_EnglishLanguageArts_ProfLevel] [varchar](500) NULL,
--	[IAB_Mathematics_ScaleScore] [varchar](500) NULL,
--	[IAB_Mathematics_ProfLevel] [varchar](500) NULL,
--	[MathSkills_Mathematics_ScaleScore] [varchar](500) NULL,
--	[MathSkills_Mathematics_ProfLevel] [varchar](500) NULL,
--	[NGSS_Science_ScaleScore] [varchar](500) NULL,
--	[NGSS_Science_ProfLevel] [varchar](500) NULL,
--	[SBAC_EnglishLanguageArts_ScaleScore] [varchar](500) NULL,
--	[SBAC_EnglishLanguageArts_ProfLevel] [varchar](500) NULL,
--	[SBAC_Mathematics_ScaleScore] [varchar](500) NULL,
--	[SBAC_Mathematics_ProfLevel] [varchar](500) NULL,
--	[AssessmentYear] [varchar](500) NULL,
--	[TenantId] [int] NULL
--)
--GO
...
(SchoolYear,[StudentId],[StudentSchool],[SchoolIdentifier],[DistrictStudentId],[StateStudentId],[StudentName],[Last_Name],[First_Name],[GradeCode]
,[Gender],[Team],[crdc_504],[SPED],[ELL],[HighNeeds],[Ethnicity],[EntryDate],[ExitDate],[Classof],[GraduationYear],[COURSE_NUMBER],[COURSE_NAME]
,[SECTION_NUMBER],[SECTIONID],[TEACHERID],[DistrictStaffID],[Teacher],[TERMID],[Q1],[Q1_per],[Q2],[Q2_per],[E1],[E1_per],[S1],[S1_per],[Q3],[Q3_per]
,[Q4],[Q4_per],[E2],[E2_per],[S2],[S2_per],[SAT_TotalScore],[SAT_ReadingScore],[SAT_ReadingBenchmark],[SAT_ReadingMetScore],[SAT_MathScore],[SAT_MathBenchmark]
,[SAT_MathMetScore],[PSAT_TotalScore],[PSAT_ReadingScore],[PSAT_ReadingBenchmark],[PSAT_ReadingMetScore],[PSAT_MathScore],[PSAT_MathBenchmark],[PSAT_MathMetScore]
,[DIBELS_Reading_ScaleScore],[DIBELS_Reading_ProfLevel],[IAB_EnglishLanguageArts_ScaleScore],[IAB_EnglishLanguageArts_ProfLevel],[IAB_Mathematics_ScaleScore]
,[IAB_Mathematics_ProfLevel],[MathSkills_Mathematics_ScaleScore],[MathSkills_Mathematics_ProfLevel],[NGSS_Science_ScaleScore],[NGSS_Science_ProfLevel]
,[SBAC_EnglishLanguageArts_ScaleScore],[SBAC_EnglishLanguageArts_ProfLevel],[SBAC_Mathematics_ScaleScore],[SBAC_Mathematics_ProfLevel]
,[AssessmentYear],[TenantId])
			SELECT distinct s.SchoolYear 
				,s.StudentId
				...
				,NULL AS [IAB_EnglishLanguageArts_ScaleScore]
				,NULL AS [IAB_EnglishLanguageArts_ProfLevel]
			...
			LEFT JOIN (
				...
				AND sg.[Course_number] = ss.[Course_number]
	...
	--where s.DistrictStudentId = '999019501' and s.schoolyear = '2024' 
